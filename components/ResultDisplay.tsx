    ...
    return (
        <div className="space-y-6 lg:space-y-8">
            ...
            <Card title="Example Code">
                {!result.exampleCode ? <div className="text-slate-400">Loading...</div> :
                    <>
            ...
            <Card title="Practice Question">
                {!result.practiceQuestion ? <div className="text-slate-400">Loading...</div> :
                    <>
            ...
            <Card title="Instructions to Solve">
                {!result.instructions ? <div className="text-slate-400">Loading...</div> :
